...
/// [KururinFlexibleSpaceBar.createSettings], to convey sizing information down to the
/// [KururinFlexibleSpaceBar].
///
/// {@tool dartpad}
/// This sample application demonstrates the different features of the
/// [KururinFlexibleSpaceBar] when used in a [SliverAppBar]. This app bar is configured
/// to stretch into the overscroll space, and uses the
/// [KururinFlexibleSpaceBar.stretchModes] to apply `fadeTitle`, `blurBackground` and
...
class KururinFlexibleSpaceBar extends StatefulWidget {
  /// Creates a flexible space bar.
  ///
  /// Most commonly used in the [AppBar.flexibleSpace] field.
  const KururinFlexibleSpaceBar({
    super.key,
    this.title,
    this.background,
    this.foreground,
  ...
  /// to the [KururinFlexibleSpaceBar].
  ///
  ...
  /// [KururinFlexibleSpaceBar] when fully collapsed. `maxExtent` sets the maximum
  /// height of the resulting [KururinFlexibleSpaceBar] when fully expanded.
  /// `currentExtent` sets the scale of the [KururinFlexibleSpaceBar.background] and
  /// [KururinFlexibleSpaceBar.title] widgets of [KururinFlexibleSpaceBar] upon
  /// initialization. `scrolledUnder` is true if the [KururinFlexibleSpaceBar]
  ...
  ///    used to specify these settings to a [KururinFlexibleSpaceBar].
  ...
  @override
  State<KururinFlexibleSpaceBar> createState() =>
      _KururinFlexibleSpaceBarState();
}

class _KururinFlexibleSpaceBarState extends State<KururinFlexibleSpaceBar> {
